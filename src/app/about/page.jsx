        ...
        <section className="bg-white px-10 mt-10">
            <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                <div className="font-light text-gray-500 sm:text-lg">
                    ...
                    <p className="mb-4">Welcome to Royal Spice Restaurant, where we bring you an exquisite dining experience infused with the rich flavors and spices of Indian ,Arabic and Chinees cuisine.</p>
                    <p className="mb-4">Nestled in the heart of Wayanad, our restaurant offers a luxurious ambiance and impeccable service,  making every visit a memorable one. we provide a vast parking fecilty also.</p>
                    <p className="mb-4">Royal Spice has become a cornerstone of the community, known for our commitment to quality and passion for excellence. Our chefs use only the freshest ingredients, sourced locally and imported, to create dishes that are both traditional and innovative.</p>
                    ...
                    <p className="mb-4">We are proud of our team of dedicated professionals who strive to provide the best service and create a dining experience that is second to none.Our friendly staff is here to ensure that you have an enjoyable and unforgettable dining experience.</p>
