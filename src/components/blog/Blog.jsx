                    ...
                    {blogPosts.map((post) => (
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <Link href="/blog">
                                    <button type="button" class="text-white bg-red-300 hover:bg-amber-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                        Read More
